  ...
  return (
    <div className="flex justify-between items-center w-full mb-7">
      ...
      <div className="flex justify-between items-center gap-5">
        ...
        <div className="relative md:w-96 sm:w-72">
          <input
            type="search"
        ...
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            <div className="w-8 h-8 bg-blue-500 rounded-md flex items-center justify-center text-white">
              {!isLoading && currentUser?.name.charAt(0).toUpperCase()}
            </div>
            <span className="font-semibold">{isLoading ? 'Loading...' : currentUser?.name}</span>
          </div>
        </div>
        <Link href="/settings">
